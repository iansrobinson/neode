...
public class AllowMultipleTest
{
    @Test
    public void shouldCreateNewRelationshipEvenIfRelationshipAlreadyExists() throws Exception
    {
        // given
        ...
        UniquenessStrategy strategy = AllowMultiple.allowMultiple();
